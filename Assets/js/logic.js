...
// var address="80 Wellesley street East"
            ...
            var queryURL="https://maps.googleapis.com/maps/api/geocode/json?address="+address+"+"+city+","+country+"&key=AIzaSyBm2fr000GAejpxrGoz6ySrEdWSVlhubfY";
            $.ajax({
              url: queryURL,
              method: 'GET'
            }).then(function(response) {
...
// get lan and lat from the geocoding api and use it in function initmap
  function initMap() {
    ...
    var map = new google.maps.Map(
        document.getElementById("map"), {zoom: 15, center: uluru});   //change the zoom from 4 to 15
